// TRAFFIC_CONDITIONER FFI Build Configuration
...
pub fn build(b: *std.Build) void {
    ...
    const header = b.addInstallHeader(
        b.path("include/traffic-conditioner.h"),
        "traffic-conditioner.h",
    );
    ...
    const bench = b.addExecutable(.{
        .name = "traffic-conditioner-bench",
