...
git clone https://github.com/hyperpolymath/system-flare.git cd
system-flare
...
toolbox create system-flare-dev toolbox enter system-flare-dev # Install
...
system-flare/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library
