...
git clone https://github.com/hyperpolymath/system-observatory.git cd
system-observatory
...
toolbox create system-observatory-dev toolbox enter
system-observatory-dev # Install dependencies manually
...
system-observatory/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ #
