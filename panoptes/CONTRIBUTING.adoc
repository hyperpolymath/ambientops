...
git clone https://github.com/hyperpolymath/panoptes.git cd panoptes
...
toolbox create panoptes-dev toolbox enter panoptes-dev # Install
...
panoptes/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library code
