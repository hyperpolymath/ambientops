...
*   **Core Invariants**: No SCM duplication, single source of truth, license consistency (MPL-2.0), and author attribution to Jonathan D.A. Jewell.
...
`displace` is licensed under the MPL-2.0 license. See the `LICENSE` file for details.
