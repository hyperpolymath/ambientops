...
This roadmap outlines a pragmatic path from the current prototype to a
mature v12 release. Version numbers are semantic milestones, not dates.
...
* Settings: icons, status chips, color-blind palette, preserve expanded
state
...
* Accessibility audit (contrast, keyboard navigation, screen reader
labels)
