...
toolbox create immutable-linux-auditor-dev toolbox enter
immutable-linux-auditor-dev # Install dependencies manually
...
immutable-linux-auditor/ ├── src/ # Source code (Perimeter 1-2) ├── lib/
