...
│  │  Ambient Guidance │  nafa-app (ReScript/Deno) — Mobile UI, weather display │
│  └────────┬─────────┘                                                        │
│           │ SystemWeather                                                     │
│           │                                                                  │
│  ┌────────▼─────────┐                                                        │
...
| nafa-app | Ward | ReScript/Deno | ~500 | Mobile journey planner + weather display
| composer | Operating Room | (planned) | 0 | Orchestration engine
|===
...
* `system-weather` — observatory produces; nafa-app displays
