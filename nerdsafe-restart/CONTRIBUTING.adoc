...
git clone https://github.com/hyperpolymath/nerdsafe-restart.git cd
nerdsafe-restart
...
toolbox create nerdsafe-restart-dev toolbox enter nerdsafe-restart-dev #
...
nerdsafe-restart/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ #
