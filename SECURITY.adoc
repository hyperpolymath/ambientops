...
[arabic]
. Navigate to
https://github.com/hyperpolymath/ambientops/security/advisories/new[Report
a Vulnerability]
...
If you cannot use GitHub Security Advisories, you may contact us
directly via GitHub by opening a private security advisory or messaging
a maintainer.
...
https://github.com/hyperpolymath/ambientops/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/ambientops/discussions[GitHub
Discussions]
...
_Thank you for helping keep AmbientOps and its users safe._ 🛡️
