...
module FFI.ABI.Foreign

import FFI.ABI.Types
import FFI.ABI.Layout
...
||| Free C string
export
%foreign "C:ffi_free_string, libffi"
prim__freeString : Bits64 -> PrimIO ()

||| Get string result from library
export
%foreign "C:ffi_get_string, libffi"
...
||| Process array data
export
%foreign "C:ffi_process_array, libffi"
...
export
%foreign "C:ffi_last_error, libffi"
...
export
%foreign "C:ffi_build_info, libffi"
...
||| Register a callback
export
%foreign "C:ffi_register_callback, libffi"
...
export
%foreign "C:ffi_is_initialized, libffi"
