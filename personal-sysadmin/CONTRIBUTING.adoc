...
git clone https://github.com/hyperpolymath/personal-sysadmin.git cd
personal-sysadmin
...
toolbox create personal-sysadmin-dev toolbox enter personal-sysadmin-dev
...
personal-sysadmin/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ #
