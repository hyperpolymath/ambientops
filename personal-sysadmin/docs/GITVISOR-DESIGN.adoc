...
*"`Dumb rules from smart learning`"* - The system learns complex
patterns through neural analysis, then distills them into simple,
fast-acting declarative rules that can be: - Pre-emptively injected into
new repos - Applied as cures to existing repos - Executed without ML
inference overhead
