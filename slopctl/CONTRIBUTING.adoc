...
git clone https://github.com/hyperpolymath/slopctl.git cd slopctl
...
toolbox create slopctl-dev toolbox enter slopctl-dev # Install
...
slopctl/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library code
