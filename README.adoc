...
[source,bash]
----
# Build all Rust components (clinician, hardware-crash-team, contracts-rust)
cargo build --workspace

# Run hardware scan
cargo run -p hardware-crash-team -- scan
...
# Run contract schema tests (requires Deno)
cd contracts && deno test
----
