...
AmbientOps a harassment-free experience for everyone, regardless of age,
...
|*GitHub* |Contact @hyperpolymath via GitHub |Detailed reports,
sensitive matters
...
. The AmbientOps Maintainers will review the report
...
The AmbientOps Maintainers will follow these guidelines in determining
consequences:
...
. *Contact* the maintainers via GitHub with subject line "`Appeal:
[Original Report ID]`"
...
* Appeals are reviewed by a different AmbientOps Maintainers member than
the original
...
* Open a
https://github.com/hyperpolymath/ambientops/discussions[Discussion] (for
general questions)
