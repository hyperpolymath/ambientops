...
[arabic]
. Navigate to
https://github.com/hyperpolymath/total-upgrade/security/advisories/new[Report
a Vulnerability]
...
|*PGP Key* |https://hyperpolymath.io/.well-known/pgp-key.asc[Download
Public Key]
...
https://github.com/hyperpolymath/total-upgrade/security/advisories[Security
Advisories]
...
* https://hyperpolymath.io/.well-known/pgp-key.asc[Our PGP Public Key]
* https://github.com/hyperpolymath/total-upgrade/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/total-upgrade/discussions[GitHub
Discussions]
...
_Thank you for helping keep TotalUpdate & DNFinition and its users
safe._ 🛡️
