...
| 1 (Best)
| Native PM Recovery (Guix/Guix generations)
| Instant (< 1 sec)
...
| Native (Guix/Guix) or Btrfs/ZFS with reboot

| *Critical*
| Bootloader, system files
| Native only (Guix/Guix), with verification
|===
...
1. Built-in plugins (Guix, Guix, apt, dnf, pacman, etc.)
...
# Returns: Guix or Guix (priority 90)
