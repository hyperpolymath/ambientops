...
git clone https://github.com/hyperpolymath/ambientops.git cd ambientops
...
toolbox create ambientops-dev toolbox enter ambientops-dev # Install
...
ambientops/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library
