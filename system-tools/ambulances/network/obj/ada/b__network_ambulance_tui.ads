...
package ada_main is
   ...
   GNAT_Version : constant String :=
                    "GNAT Version: 15.2.1 20260123 (Red Hat 15.2.1-7)" & ASCII.NUL;
   pragma Export (C, GNAT_Version, "__gnat_version");

   GNAT_Version_Address : constant System.Address := GNAT_Version'Address;
   pragma Export (C, GNAT_Version_Address, "__gnat_version_address");

   Ada_Main_Program_Name : constant String := "_ada_network_ambulance_tui" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#32e71810#;
   pragma Export (C, u00001, "network_ambulance_tuiB");
   ...
   u00141 : constant Version_32 := 16#dcb9b3d9#;
   pragma Export (C, u00141, "system__os_locksS");
   u00142 : constant Version_32 := 16#cf43d8a1#;
   ...
   u00144 : constant Version_32 := 16#7047ef61#;
   pragma Export (C, u00144, "network_stateB");
   u00145 : constant Version_32 := 16#35a9d3ea#;
   pragma Export (C, u00145, "network_stateS");
   u00146 : constant Version_32 := 16#e259c480#;
   pragma Export (C, u00146, "system__assertionsB");
   u00147 : constant Version_32 := 16#322b1494#;
   pragma Export (C, u00147, "system__assertionsS");
   u00148 : constant Version_32 := 16#8b2c6428#;
   pragma Export (C, u00148, "ada__assertionsB");
   u00149 : constant Version_32 := 16#cc3ec2fd#;
   pragma Export (C, u00149, "ada__assertionsS");
   u00150 : constant Version_32 := 16#ca878138#;
   pragma Export (C, u00150, "system__concat_2B");
   u00151 : constant Version_32 := 16#a1d318f8#;
   pragma Export (C, u00151, "system__concat_2S");
   u00152 : constant Version_32 := 16#ee9a11aa#;
   pragma Export (C, u00152, "tui_displayB");
   u00153 : constant Version_32 := 16#d17f979c#;
   pragma Export (C, u00153, "tui_displayS");
   u00154 : constant Version_32 := 16#752a67ed#;
   pragma Export (C, u00154, "system__concat_3B");
   u00155 : constant Version_32 := 16#9e5272ad#;
   pragma Export (C, u00155, "system__concat_3S");
   u00156 : constant Version_32 := 16#bcc987d2#;
   pragma Export (C, u00156, "system__concat_4B");
   u00157 : constant Version_32 := 16#27d03431#;
   pragma Export (C, u00157, "system__concat_4S");
   u00158 : constant Version_32 := 16#02cecc7b#;
   pragma Export (C, u00158, "system__concat_6B");
   u00159 : constant Version_32 := 16#967a9a07#;
   pragma Export (C, u00159, "system__concat_6S");
   u00160 : constant Version_32 := 16#0ddbd91f#;
