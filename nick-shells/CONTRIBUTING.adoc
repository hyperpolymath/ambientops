...
git clone https://github.com/hyperpolymath/nick-shells.git cd
nick-shells
...
toolbox create nick-shells-dev toolbox enter nick-shells-dev # Install
...
nick-shells/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library
