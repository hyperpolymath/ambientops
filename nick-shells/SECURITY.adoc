...
[arabic]
. Navigate to
https://github.com/hyperpolymath/nick-shells/security/advisories/new[Report
a Vulnerability]
...
https://github.com/hyperpolymath/nick-shells/security/advisories[Security
Advisories]
...
____
*Note:* This project is pre-release. Version support policy will be
updated when stable releases are published.
____
...
* https://www.shellcheck.net/[ShellCheck] - Shell script static analysis
...
|*General questions*
|https://github.com/hyperpolymath/nick-shells/discussions[GitHub
Discussions]
...
_Thank you for helping keep nick-shells and its users safe._ 🛡️
