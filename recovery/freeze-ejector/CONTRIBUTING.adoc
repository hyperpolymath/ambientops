...
git clone https://github.com/hyperpolymath/system-freeze-ejector.git cd
...
toolbox create system-freeze-ejector-dev toolbox enter
system-freeze-ejector-dev # Install dependencies manually
...
system-freeze-ejector/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ #
