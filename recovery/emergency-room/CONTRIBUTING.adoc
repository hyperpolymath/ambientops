...
git clone https://github.com/hyperpolymath/system-emergency-room.git cd
...
toolbox create system-emergency-room-dev toolbox enter
system-emergency-room-dev # Install dependencies manually
...
system-emergency-room/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ #
