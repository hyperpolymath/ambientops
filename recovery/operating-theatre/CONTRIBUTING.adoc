...
toolbox create system-operating-theatre-dev toolbox enter
system-operating-theatre-dev # Install dependencies manually
...
system-operating-theatre/ ├── src/ # Source code (Perimeter 1-2) ├──
