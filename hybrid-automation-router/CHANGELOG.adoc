...
All notable changes to HAR (Hybrid Automation Router) will be documented
in this file.
...
=== https://github.com/yourusername/hybrid-automation-router/compare/v0.1.0...HEAD[Unreleased]
...
=== https://github.com/yourusername/hybrid-automation-router/releases/tag/v0.1.0[0.1.0] - 2024-01-22 (POC Release)
...
HAR follows https://semver.org/[Semantic Versioning]:
...
link:docs/upgrades/0.x-to-1.0.md[0.x → 1.0 Migration Guide] _(not yet
available)_
